...
const EndingSection = () => {
  return (
    <section className="relative w-full min-h-screen py-20 md:py-0"> 
      {/* 배경 이미지 */}
      ...
      <motion.div 
        ...
        className="relative h-full min-h-[500px] flex flex-col items-center justify-center px-4" 
      >
        <h2 className="text-3xl sm:text-4xl md:text-6xl font-bold text-gray-900 text-center mb-4">
          Ceep로<br />쌓아 두기만 하세요.
        </h2>
      </motion.div>
